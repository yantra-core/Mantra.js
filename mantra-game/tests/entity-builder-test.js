...
tap.test('game.make() API', (t) => {
  ...
  t.test('Builder creates correct entity configuration', (t) => {
    ...
    t.deepEqual(entityConfig.position, { x: 100, y: 200, z: 0 }, 'Position should be set to (100, 200)');
  ...
  t.test('createEntity() with builder configuration', (t) => {
    ...
    t.deepEqual(game.getComponent(entity.id, 'position'), { x: 0, y: 0, z: 0 }, 'Entity position should be (0, 0)');
