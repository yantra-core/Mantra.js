...
tap.test('Lifecycle hooks - Add and trigger hook', (t) => {
  ...
  let ent = lifecycle.triggerHook('before.createEntity', mutatedEntityData);
...
tap.test('Lifecycle hooks - Sequence of multiple hooks', (t) => {
  ...
  let ent = lifecycle.triggerHook('before.createEntity', entityData);
...
tap.test('LifecycleHooks - before and after', (t) => {
  ...
  // Add a before hook
  lifecycle.before('createEntity', function(entityData){
    beforeTrigger = true;
    return entityData;
  });

  // Add an after hook
  lifecycle.after('createEntity', function(entity){
    afterTrigger = true;
    return entity;
  });
...
tap.test('Game.before and Game.after integration', (t) => {
  ...
  // Add an after hook
  game.after('createEntity', function(entity){
    afterTrigger = true;
    return entity;
  });
