...
let game = new MANTRA.Game({
  ...
  plugins: ['RBush', 'Tile', 'Bullet'], // RBush is required for Field of View
  useFoV: true,
});
...
game.start(function () {
  ...
  let tileset = new game.TileSet({
    tiles: [
      { id: 1, name: 'grass',  texture: 'tile-bush', body: true, isStatic: true, collisionStart: bushCollision }, // optional metadata properties
