...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=defaultMouseMovement;var moving=!1,movingToPosition={};function defaultMouseMovement(o){var t=o.config.mouseMovementButton||"LEFT",n=o.config.mouseActionButton||"RIGHT";o.config.mouseCameraButton;o.on("pointerUp",function(n,e){void 0!==o.currentPlayerId&&o.currentPlayerId&&(o.isTouchDevice()?n.endedFirstTouch&&(moving=!1,o.updateEntity(o.currentPlayerId,{update:null})):!1===n.buttons[t]&&(moving=!1,o.updateEntity(o.currentPlayerId,{update:null})))}),o.on("pointerMove",function(t,n){if(o.data&&o.data.ents&&o.data.ents.PLAYER){var e=t.position,i=o.data.ents.PLAYER[0];if(void 0!==i){var a=i.position;if(a&&moving){var s=Math.atan2(e.y-a.y,e.x-a.x);movingToPosition={x:e.x,y:e.y,rotation:s}}}}}),o.on("pointerDown",function(e,i){if(o.data&&o.data.ents&&o.data.ents.PLAYER){var a=e.position,s=o.data.ents.PLAYER[0];if(void 0!==s){var u=s.position;if(u){"function"!=typeof s.update&&o.updateEntity(s.id,{update:function(t){if(moving&&movingToPosition.x&&movingToPosition.y){var n=movingToPosition.rotation,e={x:1.5*Math.cos(n),y:1.5*Math.sin(n)};o.applyForce(o.data.ents.PLAYER[0].id,e)}}});var r=Math.atan2(a.y-u.y,a.x-u.x);o.isTouchDevice()?i.pointerId===e.firstTouchId?(moving=!0,movingToPosition={x:a.x,y:a.y,rotation:r}):i.pointerId===e.secondTouchId&&useItem(o,s,r):(e.buttons[t]&&(moving=!0,movingToPosition={x:a.x,y:a.y,rotation:r}),e.buttons[n]&&useItem(o,s,r))}}}})}function useItem(o,t,n){if(t.meta&&t.meta.equippedItems&&t.meta.equippedItems.length){var e=t.meta.equippedItems[0],i=o.systems[e.plugin][e.method];"function"==typeof i?i(t.id,n):console.error("Method not found",e.method)}else o.systems.boomerang&&o.systems.boomerang.throwBoomerang(t.id,n)}
