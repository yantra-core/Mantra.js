...
"use strict";function applyThrow(){if(this.isThrowing&&this.cameraThrowEnabled){var a=this.game;a.data.camera.offsetX+=this.dragInertia.x,a.data.camera.offsetY+=this.dragInertia.y,this.dragInertia.x*=.555,this.dragInertia.y*=.555,Math.abs(this.dragInertia.x)>.1||Math.abs(this.dragInertia.y)>.1?requestAnimationFrame(this.applyThrow.bind(this)):this.isThrowing=!1,this.isThrowing}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=applyThrow;

},{}],5:[function(require,module,exports){
"use strict";function cameraShake(a){var t=this,e=a.initialIntensity,n=void 0===e?100:e,r=a.duration,o=void 0===r?777:r,i=this.game,s=document.getElementById("gameHolder");if(s){if("true"!==s.dataset.isShaking){s.dataset.isShaking="true";var d=s.style.transform,c=Date.now();!function a(){var e=Date.now()-c,r=o-e;if(r<=0)return s.style.transform=d,void(s.dataset.isShaking="false");var m=n*(r/o),l=m*Math.sin(e/100)*(Math.random()>.5?1:-1),f=m*Math.cos(e/100)*(Math.random()>.5?1:-1);s.style.transform="".concat(d," translate(").concat(l,"px, ").concat(f,"px)"),Object.keys(t.game.data.ents._).forEach(function(a){var e=t.game.data.ents._[a];if("PARTICLE"===e.type||"STAR"===e.type||"HEXAPOD"===e.type||"DEMON"===e.type||"NONE"===e.type){var n=Math.random()*m-m/2,r=Math.random()*m-m/2;n*=.01,r*=.01,i.applyForce(a,{x:n,y:r})}}),requestAnimationFrame(a)}()}}else console.log("Warning: could not find gameHolder div, cannot apply camera shake")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=cameraShake;

},{}],6:[function(require,module,exports){
"use strict";function cssMouseWheelZoom(e){var t=this.game;if(this.mouseWheelEnabled&&(!t.data.camera||!0===t.data.camera.mouseWheelZoomEnabled)){this.game.systems.mouse;var a=e.target;if("CODE"===a.tagName.toUpperCase()&&(a=a.parentNode),["TEXTAREA","PRE","CODE","BUTTON","INPUT"].includes(a.tagName.toUpperCase())){if(a.scrollHeight>a.clientHeight)return;e.preventDefault()}else e.preventDefault();var o=t.data.camera.currentZoom,s=.03,r=1e-4,l=2,m=(e.wheelDelta?e.wheelDelta:-e.detail)>0?1:-1,u=s*Math.log(o+l)/Math.log(l),h=Math.max(r,o+m*u);return this.zoom(h),!1}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=cssMouseWheelZoom;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=update;var _zoom=_interopRequireDefault(require("./zoom.js"));function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function update(){var a=this.game,t=this.game.getEntity(a.currentPlayerId),e=(a.data.camera.currentZoom,window.innerHeight),r=window.innerWidth;if(a.data.camera.adaptiveZoom){var o=r/a.config.width,i=e/a.config.height,s=Math.min(o,i),n=2.5;"number"==typeof a.data.camera.scaleMultiplier&&(n=a.data.camera.scaleMultiplier),a.setZoom(s*n)}this.game.data.camera.currentZoom;"number"!=typeof a.data.camera.offsetX&&(a.data.camera.offsetX=0),"number"!=typeof a.data.camera.offsetY&&(a.data.camera.offsetY=0),"number"!=typeof a.data.camera.offsetX&&(a.data.camera.offsetX=0),"number"!=typeof a.data.camera.offsetY&&(a.data.camera.offsetY=0);var m=0,c=0;"follow"===this.game.data.camera.mode&&t&&t.position&&(m=t.position.x,c=t.position.y),this.scene.cameraPosition.x=m+a.data.camera.offsetX,this.scene.cameraPosition.y=c+a.data.camera.offsetY;var d=window.innerWidth/2,f=window.innerHeight/2,u={x:this.scene.cameraPosition.x-d,y:this.scene.cameraPosition.y-f};u.x*=this.game.data.camera.currentZoom,u.y*=this.game.data.camera.currentZoom;var h=window.innerWidth/this.game.data.camera.currentZoom,l=window.innerHeight/this.game.data.camera.currentZoom,g=(window.innerWidth,(window.innerHeight-l)/2);this.game.data.camera.currentZoom,g*=this.game.data.camera.currentZoom,u.y+=g,this.scene.renderDiv&&setTransform(this.scene.renderDiv,-u.x,-u.y,this.game.data.camera.currentZoom,0),this.game.data.camera.position=this.scene.cameraPosition}function setTransform(a,t,e,r,o){var i=parseFloat(a.dataset.lastOffsetX)||0,s=parseFloat(a.dataset.lastOffsetY)||0,n=parseFloat(a.dataset.lastZoom)||1,m=parseFloat(a.dataset.lastRotation)||0;t=Number.isFinite(t)?t:i,e=Number.isFinite(e)?e:s,r=Number.isFinite(r)&&r>0?r:n,o=Number.isFinite(o)?o:m,t===i&&e===s&&r===n&&o===m||(a.style.transform="translate(".concat(t,"px, ").concat(e,"px) scale(").concat(r,") rotate(").concat(o,"deg)"),a.dataset.lastOffsetX=t.toString(),a.dataset.lastOffsetY=e.toString(),a.dataset.lastZoom=r.toString(),a.dataset.lastRotation=o.toString())}

},{"./zoom.js":12}],10:[function(require,module,exports){
"use strict";function updateCameraPosition(a,t,i){var e=this.game,r=!0;"boolean"==typeof e.data.camera.draggingAllowed&&(r=e.data.camera.draggingAllowed),r&&(this.isDragging&&!i&&this.cancelThrow(),i&&(this.isDragging=!0,"number"==typeof a&&(e.data.camera.offsetX+=a),"number"==typeof t&&(e.data.camera.offsetY+=t)),!this.isDragging||i||0===a&&0===t||(this.isThrowing=!0,this.isDragging=!1,Math.abs(a)>2&&(this.dragInertia.x=1.6*a),Math.abs(t)>2&&(this.dragInertia.y=1.6*t),requestAnimationFrame(this.applyThrow.bind(this))),i||(this.isDragging=!1))}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=updateCameraPosition;
...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function createGraphic(t){if(!0!==t.destroyed){var e=document.createElement("div");switch(e.id="entity-".concat(t.id),e.setAttribute("mantra-id",t.id),e.className="entity-element",e.style.position="absolute",void 0!==t.rotation&&null!==t.rotation&&("object"===_typeof(t.rotation)?t.rotation=t.rotation.x:t.rotation=t.rotation),t.type){case"BULLET":t.radius;e.style.width=t.radius+"px",e.style.height=t.radius+"px",this.inflateBox(e,t);break;case"PLAYER":e.style.width=t.width+"px",e.style.height=t.height+"px",this.inflateBox(e,t);break;case"TEXT":e=this.inflateText(e,t);break;case"BUTTON":this.game.systems.button&&(e=this.game.systems.button.inflate(e,t));break;case"LINK":this.game.systems.link&&(e=this.game.systems.link.inflate(e,t));break;case"INPUT":e=this.inflateInput(e,t);break;case"SELECT":this.game.systems.select&&(e=this.game.systems.select.inflate(e,t));break;case"IMAGE":e=this.inflateImage(e,t);break;case"TEXTAREA":e=this.inflateTextarea(e,t);break;case"RANGE":e=this.inflateRange(e,t);break;case"CHECKBOX":this.game.systems.checkbox&&(e=this.game.systems.checkbox.inflate(e,t));break;case"RADIO":e=this.inflateRadio(e,t);break;case"IFRAME":e=this.inflateIframe(e,t);break;case"CANVAS":e=this.inflateCanvas(e,t);break;case"MONACO":console.log("inflating monaco",t,this.game.systems),this.game.systems.monaco&&(e=this.game.systems.monaco.inflate(e,t));break;case"CODE":this.game.systems.code&&(e=this.game.systems.code.inflate(e,t));break;case"TOOLBAR":this.game.systems.toolbar&&(e=this.game.systems.toolbar.inflate(e,t));break;default:"PART"===t.type&&"Display"===t.name?this.inflateText(e,t):this.inflateBox(e,t)}if(void 0!==t.radius&&(e.style.width=t.radius+"px",e.style.height=t.radius+"px",e.style.borderRadius="50%"),void 0!==t.color&&null!==t.color)t.color.toString(16),Math.floor(16777215*Math.random()).toString(16);if("object"===_typeof(t.style)&&("absolute"===t.style.position||"fixed"===t.style.position)){var i=document.getElementById("gameHolder");if(e.style.position="flex",!0===t.style.positionScreen)e.style.top="".concat(t.position.y,"px"),e.style.left="".concat(t.position.x,"px"),e.style.width="".concat(t.width,"px"),e.style.height="".concat(t.height,"px");else{var s={};window.innerWidth,window.innerHeight;s.x=t.position.x+window.innerWidth/2,s.y=t.position.y+window.innerHeight/2,e.style.top="".concat(s.y,"px"),e.style.left="".concat(s.x,"px"),e.style.width="".concat(t.width,"px"),e.style.height="".concat(t.height,"px")}return i.appendChild(e),e}return this.renderDiv.appendChild(e),this.updateEntityPosition(e,t),e}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=createGraphic;

},{}],16:[function(require,module,exports){
"use strict";function inflateBox(e,t){this.game.getTexture;var s=this.depthChart,i="white";if(void 0!==t.color&&null!==t.color&&(i="#"+t.color.toString(16)),"number"==typeof t.radius?(e.style.width=t.radius+"px",e.style.height=t.radius+"px"):(e.style.width=t.width+"px",e.style.height=t.height+"px"),e.style.zIndex=t.position.z,"PART"===t.type){switch(t.name){case"Wire":case"Display":e.style.zIndex=-1;break;default:e.style.zIndex=s.indexOf("PART")}this.bindYCraftEvents(t,e)}return e.style.border=e.style.border||"1px solid black",e.style.background=i,t.style&&Object.keys(t.style).forEach(function(s){e.style[s]=t.style[s]}),this.updateEntityPosition(e,t),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=inflateBox;
...
"use strict";function inflateIframe(e,t){var a=document.createElement("iframe");return t.meta&&t.meta.src&&(null===t.meta.src?a.src="about:blank":a.src=t.meta.src||"about:blank"),applyIframeStyles(a,t),e.appendChild(a),t.width&&(a.style.width="".concat(t.width,"px")),t.height&&(a.style.height="".concat(t.height,"px")),e}function applyIframeStyles(e,t){e.style.border="2px solid #999",e.style.boxShadow="0 0 8px 0 rgba(0, 0, 0, 0.1)",e.style.transition="all 0.3s ease-in-out";t.style&&"none"!==t.style.border&&(e.addEventListener("mouseenter",function(){e.style.border="2px solid #fff",e.style.boxShadow="0 0 15px 5px rgba(0, 150, 255, 0.7)"}),e.addEventListener("mouseleave",function(){e.style.border="2px solid #999",e.style.boxShadow="0 0 8px 0 rgba(0, 0, 0, 0.1)"})),e.addEventListener("message",function(e){game.emit("iframeMessage",e)})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=inflateIframe;

},{}],19:[function(require,module,exports){
"use strict";function inflateImage(e,t){var a;if(t.meta&&void 0!==t.meta.imageData){if(!(t.meta.imageData instanceof HTMLCanvasElement))return void console.error("Unsupported imageData type:",t.meta.imageData);a=t.meta.imageData}else a=document.createElement("img"),t.meta&&t.meta.src&&(a.src=t.meta.src);return t.meta&&t.meta.alt?a.alt=t.meta.alt:a.alt=t.meta.src||"Image "+t.id,t.meta&&t.meta.title&&(a.title=t.meta.title),applyImageStyles(a,t),e.appendChild(a),t.width&&(a.style.width="".concat(t.width,"px")),t.height&&(a.style.height="".concat(t.height,"px")),e}function applyImageStyles(e,t){e.style.border="none",t.styles&&Object.keys(t.styles).forEach(function(a){e.style[a]=t.styles[a]})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=inflateImage;
...
"use strict";function inflateRange(e,t){var n=document.createElement("input");return n.type="range",n.value=t.value||100,t.min&&(n.min=t.min),t.max&&(n.max=t.max),t.step&&(n.step=t.step),applyRangeStyles(n,t),console.log("rrrrr",n),e.appendChild(n),t.width&&(e.style.width="".concat(t.width,"px")),t.color&&(e.style.color=convertColorToHex(t.color)),n.addEventListener("input",function(e){var n=e.target;game.updateEntity(t.id,{value:n.value})}),e}function applyRangeStyles(e,t){Object.assign(e.style,{display:"block",width:"100%",margin:"8px 0",cursor:"pointer"},t.style)}function convertColorToHex(e){return"number"==typeof e?"#".concat(e.toString(16)):e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=inflateRange;
...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function updateGraphic(t){this.game;void 0!==t.rotation&&null!==t.rotation&&("object"===_typeof(t.rotation)?t.rotation=t.rotation.x:t.rotation=t.rotation);var e=document.getElementById("entity-".concat(t.id));if(e){if(void 0!==t.color&&null!==t.color&&"TEXT"!==t.type){var o="#"+t.color.toString(16);e.style.background=o}if("number"==typeof t.position.z&&(e.style.zIndex=t.position.z),"TEXT"===t.type&&void 0!==t.text&&null!==t.text&&e.innerHTML!==t.text&&(e.innerHTML=t.text),void 0!==t.width&&(e.style.width=t.width+"px"),void 0!==t.height&&(e.style.height=t.height+"px"),"number"!=typeof t.radius);else{var i=2*t.radius;e.style.width=i+"px",e.style.height=i+"px"}if("object"===_typeof(t.size)&&(void 0!==t.size.width&&(e.style.width=t.size.width+"px"),void 0!==t.size.height&&(e.style.height=t.size.height+"px")),t.style&&Object.keys(t.style).forEach(function(o){e.style[o]=t.style[o]}),"IFRAME"===t.type){var r=e.querySelector("iframe");r&&r.src!==t.meta.src&&(null===t.meta.src?r.src="about:blank":r.src=t.meta.src||"about:blank")}if("LINK"===t.type){var n=e.querySelector("a");n&&(t.text&&n.innerText!==t.text&&(n.innerText=t.text),t.meta.target&&n.target!==t.meta.target&&(n.target=t.meta.target),t.meta.href&&n.href!==t.meta.href&&(n.href=t.meta.href))}if("CODE"===t.type)e.querySelector('code[data-src="'.concat(t.meta.src,'"]'))||(console.log("No code element with matching data-src found.",t.meta.src),this.game.systems.code&&this.game.systems.code.inflate(e,t));return!t.style||"fixed"!==t.style.position&&"absolute"!==t.style.position?this.updateEntityPosition(e,t):e}return this.createGraphic(t)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=updateGraphic;

},{}],29:[function(require,module,exports){
"use strict";function _slicedToArray(e,r){return _arrayWithHoles(e)||_iterableToArrayLimit(e,r)||_unsupportedIterableToArray(e,r)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _iterableToArrayLimit(e,r){var t=null==e?null:"undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(null!=t){var n,i,a,o,l=[],u=!0,s=!1;try{if(a=(t=t.call(e)).next,0===r){if(Object(t)!==t)return;u=!1}else for(;!(u=(n=a.call(t)).done)&&(l.push(n.value),l.length!==r);u=!0);}catch(e){s=!0,i=e}finally{try{if(!u&&null!=t.return&&(o=t.return(),Object(o)!==o))return}finally{if(s)throw i}}return l}}function _arrayWithHoles(e){if(Array.isArray(e))return e}function _createForOfIteratorHelper(e,r){var t="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(!t){if(Array.isArray(e)||(t=_unsupportedIterableToArray(e))||r&&e&&"number"==typeof e.length){t&&(e=t);var n=0,i=function(){};return{s:i,n:function(){return n>=e.length?{done:!0}:{done:!1,value:e[n++]}},e:function(e){throw e},f:i}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var a,o=!0,l=!1;return{s:function(){t=t.call(e)},n:function(){var e=t.next();return o=e.done,e},e:function(e){l=!0,a=e},f:function(){try{o||null==t.return||t.return()}finally{if(l)throw a}}}}function _unsupportedIterableToArray(e,r){if(e){if("string"==typeof e)return _arrayLikeToArray(e,r);var t=Object.prototype.toString.call(e).slice(8,-1);return"Object"===t&&e.constructor&&(t=e.constructor.name),"Map"===t||"Set"===t?Array.from(e):"Arguments"===t||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?_arrayLikeToArray(e,r):void 0}}function _arrayLikeToArray(e,r){(null==r||r>e.length)&&(r=e.length);for(var t=0,n=new Array(r);t<r;t++)n[t]=e[t];return n}function render(e,r){var t=this;if(this.game.config.useFoV){new Map;var n=this.game.data.currentPlayer;e.getPlayerFieldOfView(n,e.data.fieldOfView,!1).forEach(function(e){var n=t.game.entities.get(e);n&&t.inflateGraphic(n,r)})}else{var i,a=_createForOfIteratorHelper(this.game.entities.entries());try{for(a.s();!(i=a.n()).done;){var o=_slicedToArray(i.value,2),l=o[0],u=(o[1],this.game.entities.get(l));if(!0!==u.isStatic&&this.game.config.entityEmitsViewportExitEvent&&u&&u.position&&u.size){var s=this.isEntityInViewport(u,this.game.data.camera.currentZoom);s.inViewport||(u.screenPosition=s.adjustedPosition,u.direction=s.direction,this.game.emit("entity::exited::viewport",u))}this.inflateGraphic(u,r)}}catch(e){a.e(e)}finally{a.f()}}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=render;
