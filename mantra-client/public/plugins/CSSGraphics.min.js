...
"use strict";function cssMouseWheelZoom(e){var a=this.game;if(this.mouseWheelEnabled&&(!a.data.camera||!0===a.data.camera.mouseWheelZoomEnabled)){this.game.systems.mouse;var t=e.target;if("CODE"===t.tagName.toUpperCase()&&(t=t.parentNode),["TEXTAREA","PRE","CODE","BUTTON","INPUT"].includes(t.tagName.toUpperCase())){if(t.scrollHeight>t.clientHeight)return;e.preventDefault()}else e.preventDefault();var o=a.data.camera.currentZoom,s=.001,l=1e-4,r=2,m=(e.wheelDelta?e.wheelDelta:-e.detail)>0?1:-1,u=s*Math.log(o+r)/Math.log(r),h=Math.max(l,o+m*u);return console.log("newScale",h),this.zoom(h),!1}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=cssMouseWheelZoom;
