...
"use strict";function inflateSelect(e,t){var o=document.createElement("select");if(t.meta&&t.meta.options){var r=t.meta.options;Array.isArray(r)&&r.forEach(function(e){var t=document.createElement("option");t.value=e.value,t.textContent=e.label,e.selected&&(t.selected=!0),o.appendChild(t)})}return applySelectStyles(o,t),e.appendChild(o),t.width&&(e.style.width="".concat(t.width,"px")),t.color&&(e.style.color=convertColorToHex(t.color)),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=inflateSelect;var defaultSelectStyles={padding:"10px 15px",fontSize:"16px",margin:"4px 2px",cursor:"pointer",borderRadius:"8px",backgroundColor:"#f2f2f2",color:"black",border:"1px solid #ccc",appearance:"none",transition:"border-color 0.4s ease, box-shadow 0.4s ease"};function applySelectStyles(e,t){Object.assign(e.style,defaultSelectStyles,t.style),e.addEventListener("focus",function(){e.style.borderColor="#80bdff",e.style.boxShadow="0 0 0 0.2rem rgba(0,123,255,.25)"}),e.addEventListener("blur",function(){e.style.borderColor="#ccc",e.style.boxShadow="none"}),e.addEventListener("change",function(e){var o=e.target;game.updateEntity(t.id,{value:o.value})})}function convertColorToHex(e){return"number"==typeof e?"#".concat(e.toString(16)):e}
...
"use strict";function inflateTextarea(e,t){var a=document.createElement("textarea");return a.textContent=t.text||"",applyTextareaStyles(a,t),e.appendChild(a),t.width&&(a.style.width="".concat(t.width,"px")),t.height&&(a.style.height="".concat(t.height,"px")),t.color&&(a.style.color=convertColorToHex(t.color)),e}function applyTextareaStyles(e,t){}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=inflateTextarea;
