...
"use strict";function inflateCode(e,t){var o,r,s=this,n=t.graphics&&t.graphics["graphics-css"];n?(o=n.querySelectorAll("pre")[0],r=n.querySelectorAll("code")[0]):(o=document.createElement("pre"),r=document.createElement("code"),o.appendChild(r),e.appendChild(o));t.meta.language;r.classList.add("language-javascript"),this.fetchSourceHandles=this.fetchSourceHandles||{};var a=t.meta&&t.meta.src;return a?(r.textContent="Loading... ".concat(a),this.fetchSourceHandles[a]||(this.fetchSourceHandles[a]=fetch(a).then(function(e){if(!e.ok)throw new Error("Network response was not ok");return e.text()}).then(function(e){Array.from(document.querySelectorAll('code[data-src="'.concat(a,'"]'))).forEach(function(t){var o=Prism.highlight(e,Prism.languages.javascript,"javascript");t.innerHTML=o}),s.fetchSourceHandles[a]={content:e}}).catch(function(e){throw console.error("Error fetching source code:",e),Array.from(document.querySelectorAll('code[data-src="'.concat(a,'"]'))).forEach(function(t){t.textContent="// Error fetching source code \n"+e}),s.fetchSourceHandles[a]={error:"// Error fetching source code"},e})),r.setAttribute("data-src",a)):r.textContent=t.meta&&t.meta.code||"",applyCodeStyles(e,o,r,t),t.width&&(o.style.width="".concat(t.width,"px")),t.height&&(o.style.height="".concat(t.height,"px")),t.color&&(r.style.color=convertColorToHex(t.color)),e}function applyCodeStyles(e,t,o,r){t.style.display="block",t.style.overflow="auto",t.style.padding="5px",t.style.backgroundColor="#1E1E1E",o.style.fontFamily="monospace",o.style.fontSize="14px",o.style.color="#D4D4D4",e.style.boxShadow="0 0 8px 0 rgba(0, 0, 0, 0.1)",e.style.transition="all 0.3s ease-in-out";e.addEventListener("mouseenter",function(){e.style.border="2px solid #fff",e.style.boxShadow="0 0 15px 5px rgba(0, 150, 255, 0.7)"}),e.addEventListener("mouseleave",function(){e.style.border="2px solid #999",e.style.boxShadow="0 0 8px 0 rgba(0, 0, 0, 0.1)"}),r.style&&(Object.assign(t.style,r.style.pre),Object.assign(o.style,r.style.code))}function applyIframeStyles(e,t){e.style.border="2px solid #999",e.style.boxShadow="0 0 8px 0 rgba(0, 0, 0, 0.1)",e.style.transition="all 0.3s ease-in-out";e.addEventListener("mouseenter",function(){e.style.border="2px solid #fff",e.style.boxShadow="0 0 15px 5px rgba(0, 150, 255, 0.7)"}),e.addEventListener("mouseleave",function(){e.style.border="2px solid #999",e.style.boxShadow="0 0 8px 0 rgba(0, 0, 0, 0.1)"})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=inflateCode;
