...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var _gui=_interopRequireDefault(require("../gui-editor/gui.js"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,_toPropertyKey(n.key),n)}}function _createClass(e,t,i){return t&&_defineProperties(e.prototype,t),i&&_defineProperties(e,i),Object.defineProperty(e,"prototype",{writable:!1}),e}function _defineProperty(e,t,i){return(t=_toPropertyKey(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}function _toPropertyKey(e){var t=_toPrimitive(e,"string");return"symbol"===_typeof(t)?t:String(t)}function _toPrimitive(e,t){if("object"!==_typeof(e)||null===e)return e;var i=e[Symbol.toPrimitive];if(void 0!==i){var n=i.call(e,t||"default");if("object"!==_typeof(n))return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}var GuiMidi=function(){function e(){_classCallCheck(this,e),this.id=e.id,this.midiLog=[]}return _createClass(e,[{key:"init",value:function(e){this.game=e,e.on("midi-data",this.logMidiData.bind(this)),e.on("midi::log",this.logMidiEvent.bind(this)),this.createMidiWindow()}},{key:"logMidiEvent",value:function(e){var t=document.createElement("p");t.textContent="MIDI Event: ".concat(e),this.logElement.appendChild(t)}},{key:"createMidiWindow",value:function(){var t=this;this.midiView=_gui.default.window("midiView","MIDI Debug",function(){t.game.systemsManager.removeSystem(e.id)});var i=this.midiView.querySelector(".gui-content");this.logElement=document.createElement("div"),this.logElement.id="midi-log",i.appendChild(this.logElement)}},{key:"logMidiData",value:function(e){this.midiLog.push(e),this.updateLogDisplay()}},{key:"updateLogDisplay",value:function(){var e=this;this.logElement.innerHTML="",this.midiLog.forEach(function(t){var i=document.createElement("p");i.textContent="MIDI Data: ".concat(t),e.logElement.appendChild(i)})}},{key:"unload",value:function(){this.midiView&&this.midiView.remove()}}]),e}();_defineProperty(GuiMidi,"id","gui-midi");var _default=exports.default=GuiMidi;
