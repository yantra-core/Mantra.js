...
var RBushModule = _interopRequireWildcard(require("rbush"));
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // RBush.js - Mantra Game Plugin - Marak Squires 2024
...
var RBush = /*#__PURE__*/function () {
  ...
  _createClass(RBush, [{
    ...
    key: "_extractSpatialData",
    value: function _extractSpatialData(entity) {
      var id = entity.id,
    ...
    value: function update() {
      ...
      var nearbyEntities = game.getPlayerFieldOfView(currentPlayer, this.game.data.fieldOfView * 1.5, false);
      nearbyEntities.forEach(function (eId) {
        if (eId) {
          ...
          if (!exists) {
            ...
            delete _this2.game.deferredEntities[eId];
          }
        }
      });
    }
...
_defineProperty(RBush, "id", 'rbush');
