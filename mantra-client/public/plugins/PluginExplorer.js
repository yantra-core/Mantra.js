(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}(g.PLUGINS || (g.PLUGINS = {})).PluginExplorer = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // PluginExplorer.js - Marak Squires 2023
var PluginExplorer = /*#__PURE__*/function () {
  function PluginExplorer() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, PluginExplorer);
    this.id = PluginExplorer.id;
    this.pluginInstances = [];
  }
  _createClass(PluginExplorer, [{
    key: "init",
    ...
    key: "drawPluginForm",
    value: function drawPluginForm(pluginInstance, pluginClass) {
      ...
      if (!container) {
        ...
        container = _gui["default"].window('pluginExplorer', 'Plugin Explorer', function () {
      ...
      var staticMembers = Object.getOwnPropertyNames(pluginClass);

      // Get static methods
      var staticMethods = Object.getOwnPropertyNames(pluginClass).filter(function (prop) {
        return typeof pluginClass[prop] === 'function';
      });

      // Get instance methods
      var instanceMethods = Object.getOwnPropertyNames(Object.getPrototypeOf(pluginInstance)).filter(function (prop) {
        return typeof pluginInstance[prop] === 'function' && prop !== 'constructor';
      });

      // Get instance properties (non-methods)
      var instanceProperties = Object.getOwnPropertyNames(pluginInstance).filter(function (prop) {
        return typeof pluginInstance[prop] !== 'function';
      });

      // Create a container for the form
      var formContainer = document.createElement('div');
      formContainer.id = "".concat(pluginInstance.constructor.name, "-form");
      formContainer.className = 'plugin-form-container';

      // Function to create forms for methods
      var createMethodForm = function createMethodForm(method, isStatic) {
        var form = document.createElement('form');
        form.id = "".concat(method, "-form");
        form.className = 'method-form';
        form.innerHTML = "\n        <label class=\"method-label\" for=\"".concat(method, "-input\">").concat(isStatic ? 'Static: ' : '').concat(method, "</label>\n        <input class=\"method-input\" type=\"text\" id=\"").concat(method, "-input\" name=\"").concat(method, "-input\">\n        <button class=\"submit-button\" type=\"submit\">Execute</button>\n      ");

        // Event listener for form submission
        form.addEventListener('submit', function (event) {
          event.preventDefault();
          var input = form.querySelector("#".concat(method, "-input")).value;
          var result = isStatic ? pluginClass[method](input) : pluginInstance[method](input);
          console.log("Result of ".concat(method, ":"), result); // Handle the result as needed
        });
      ...
      staticMembers.forEach(function (member) {
        if (typeof pluginClass[member] === 'function') {
          ...
          var value = pluginClass[member];
          if (_typeof(value) === 'object') {
            // value = JSON.stringify(value, true, 2);
            value = '[ Object ]';
          }
          var staticPropDiv = document.createElement('div');
          staticPropDiv.className = 'property-display';
          staticPropDiv.innerHTML = "<strong>Static ".concat(member, ":</strong> ").concat(value);
      ...
      instanceProperties.forEach(function (property) {
        ...
        var value = pluginInstance[property];
        if (_typeof(value) === 'object') {
        ...
        propDiv.innerHTML = "<strong>".concat(property, ":</strong> ").concat(value);
...
_defineProperty(PluginExplorer, "id", 'gui-plugin-explorer');
var _default = exports["default"] = PluginExplorer; // TODO: add method to simulate game state / replay gametate
