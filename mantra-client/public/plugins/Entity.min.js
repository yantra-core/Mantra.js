...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=createEntity;var _Entity=_interopRequireDefault(require("../../../Entity/Entity.js")),_TimersComponent=_interopRequireDefault(require("../../../Component/TimersComponent.js")),_ensureColorInt=_interopRequireDefault(require("./util/ensureColorInt.js")),_layoutEntity=_interopRequireDefault(require("./layoutEntity.js"));function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function ownKeys(t,e){var i=Object.keys(t);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(t);e&&(n=n.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),i.push.apply(i,n)}return i}function _objectSpread(t){for(var e=1;e<arguments.length;e++){var i=null!=arguments[e]?arguments[e]:{};e%2?ownKeys(Object(i),!0).forEach(function(e){_defineProperty(t,e,i[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(i)):ownKeys(Object(i)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(i,e))})}return t}function _defineProperty(t,e,i){return(e=_toPropertyKey(e))in t?Object.defineProperty(t,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[e]=i,t}function _toPropertyKey(t){var e=_toPrimitive(t,"string");return"symbol"===_typeof(e)?e:String(e)}function _toPrimitive(t,e){if("object"!==_typeof(t)||null===t)return t;var i=t[Symbol.toPrimitive];if(void 0!==i){var n=i.call(t,e||"default");if("object"!==_typeof(n))return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===e?String:Number)(t)}function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function distanceSquared(t,e,i,n){var o=i-t,a=n-e;return o*o+a*a}function deferEntityCreation(t){spatialStructure.add(t)}function createEntity(){var t,e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},i=arguments.length>1&&void 0!==arguments[1]&&arguments[1];if(e=this.game.lifecycle.triggerHook("before.createEntity",e),!i){var n={id:t=this._generateId(),name:null,kind:null,body:!0,shape:"triangle",color:null,position:{x:0,y:0,z:0},startingPosition:null,velocity:{x:0,y:0,z:0},rotation:0,mass:100,density:100,health:1/0,score:0,height:100,width:100,depth:16,size:{width:100,height:100,depth:16},lifetime:null,maxSpeed:9999,isStatic:!1,isSensor:!1,restitution:0,container:null,items:null,sutra:null,scene:[],meta:null,collectable:!1,hasInventory:!0,owner:0,inputs:null,value:null,destroyed:!1,type:"NONE",friction:.1,frictionAir:.01,frictionStatic:.5,lockedProperties:null,actionRateLimiter:null,timers:null,yCraft:null,text:null,style:null,texture:null,collisionStart:!0,collisionActive:!1,collisionEnd:!1,pointerdown:!1,pointerup:!1,pointermove:!1,pointerover:!1,pointerout:!1,pointerenter:!1,pointerleave:!1,onDrop:null,afterItemCollected:null,afterRemoveEntity:null,afterCreateEntity:null,update:null,exit:null,ctick:this.game.tick};if("object"===_typeof(e.size)?(e.width=e.size.width,e.height=e.size.height,e.depth=e.size.depth):e.size={width:e.width,height:e.height,depth:e.depth},(e=_objectSpread(_objectSpread({},n),e)).position&&("number"!=typeof e.position.x||isNaN(e.position.x)||"number"!=typeof e.position.y||isNaN(e.position.y)))throw console.log("Entity.createEntity could not create with data",e),new Error("Invalid position for entity");if(this.game.systems.rbush&&this.game.systems.rbush.addEntity(e),this.game.deferredEntities[e.id.toString()]=e,this.game.config.useFoV){var o=this.game.getCurrentPlayer();if(o){var a=e.position||{x:0,y:0,z:0};if(distanceSquared(o.position.x,o.position.y,a.x,a.y)>this.game.data.fieldOfView*this.game.data.fieldOfView)return}}}t=e.id;new _Entity.default(t);e.startingPosition||(e.startingPosition=e.position);var r,s=e,d=s.name,m=s.type,p=s.kind,l=s.position,h=s.rotation,c=s.startingPosition,u=s.body,g=s.mass,y=s.density,f=s.velocity,C=s.isSensor,v=s.isStatic,b=s.lockedProperties,_=s.width,E=s.height,w=s.depth,S=s.size,P=s.radius,j=s.shape,x=s.color,O=s.maxSpeed,R=s.health,k=s.score,D=s.items,I=s.container,q=s.sutra,z=s.scene,A=s.meta,N=s.collectable,T=s.hasInventory,K=s.owner,V=s.inputs,L=s.value,H=s.lifetime,M=s.yCraft,F=s.text,W=s.style,Y=s.texture,B=s.collisionActive,G=s.collisionStart,J=s.collisionEnd,Q=s.pointerdown,U=s.pointerup,X=s.pointermove,Z=s.pointerenter,$=s.pointerleave,tt=s.pointerover,et=s.pointerout,it=s.onDrop,nt=s.afterRemoveEntity,ot=(s.afterCreateEntity,s.afterItemCollected),at=s.update,rt=s.exit,st=s.ctick,dt=(l.x,l.y,(0,_ensureColorInt.default)(x));if(this.game.addComponent(t,"type",m||"PLAYER"),this.game.addComponent(t,"name",d||null),this.game.addComponent(t,"kind",p),this.game.addComponent(t,"position",l),this.game.addComponent(t,"startingPosition",c),this.game.addComponent(t,"velocity",f),this.game.addComponent(t,"rotation",h),this.game.addComponent(t,"mass",g),this.game.addComponent(t,"density",y),this.game.addComponent(t,"health",R),this.game.addComponent(t,"score",k),this.game.addComponent(t,"width",_),this.game.addComponent(t,"height",E),this.game.addComponent(t,"depth",w),this.game.addComponent(t,"size",S),this.game.addComponent(t,"radius",P),this.game.addComponent(t,"shape",j),this.game.addComponent(t,"color",dt),this.game.addComponent(t,"maxSpeed",O),this.game.addComponent(t,"owner",K),this.game.addComponent(t,"items",D),this.game.addComponent(t,"scene",z),this.game.addComponent(t,"meta",A),this.game.addComponent(t,"collectable",N),this.game.addComponent(t,"hasInventory",T),this.game.addComponent(t,"value",L),this.game.addComponent(t,"inputs",V),this.game.addComponent(t,"lifetime",H),this.game.addComponent(t,"destroyed",!1),this.game.addComponent(t,"creationTime",Date.now()),this.game.addComponent(t,"isSensor",C),this.game.addComponent(t,"isStatic",v),this.game.addComponent(t,"lockedProperties",b),this.game.addComponent(t,"actionRateLimiter",{}),this.game.addComponent(t,"timers",new _TimersComponent.default("timers",t,this.game)),this.game.addComponent(t,"yCraft",M),this.game.addComponent(t,"text",F),this.game.addComponent(t,"style",W),this.game.addComponent(t,"texture",Y),this.game.addComponent(t,"afterItemCollected",ot),this.game.addComponent(t,"afterRemoveEntity",nt),this.game.addComponent(t,"afterCreateEntity",nt),this.game.addComponent(t,"collisionActive",B),this.game.addComponent(t,"collisionStart",G),this.game.addComponent(t,"collisionEnd",J),this.game.addComponent(t,"pointerdown",Q),this.game.addComponent(t,"pointerup",U),this.game.addComponent(t,"pointermove",X),this.game.addComponent(t,"pointerenter",Z),this.game.addComponent(t,"pointerleave",$),this.game.addComponent(t,"pointerover",tt),this.game.addComponent(t,"pointerout",et),this.game.addComponent(t,"onDrop",it),this.game.addComponent(t,"update",at),this.game.addComponent(t,"exit",rt),this.game.addComponent(t,"ctick",st),"object"===_typeof(q)&&null!==q&&"function"==typeof q.rules?("object"!==_typeof(q.config)&&(q.config={}),r=q.rules(this.game,t,q.config)):r=q,this.game.addComponent(t,"sutra",r),u){var mt={entityId:t,width:_,height:E,radius:P,type:m,shape:j,position:l,velocity:f,rotation:h,mass:g,density:y,isStatic:v,isSensor:C,restitution:e.restitution,friction:e.friction,frictionAir:e.frictionAir,frictionStatic:e.frictionStatic};mt.myEntityId=t,this.game.physics.addToWorld(mt),!f||0===f.x&&0===f.y||this.game.physics.setVelocity(t,f),l&&this.game.physics.setPosition(t,l),void 0!==h&&this.game.physics&&this.game.physics.setRotation&&this.game.physics.setRotation(t,h)}this.game.entities.set(t,{id:t});var pt,lt=this.game.getEntity(t);return void 0===lt.pendingRender&&(lt.pendingRender={}),this.game.graphics.forEach(function(t){lt.pendingRender[t.id]=!0}),this.game.entities.set(t,lt),I&&this.layoutEntity(I,t),this.game.data.ents=this.game.data.ents||{},this.game.data.ents._=this.game.data.ents._||{},this.game.data.ents._[t]=lt,this.game.data.ents[lt.type]=this.game.data.ents[lt.type]||[],this.game.data.ents[lt.type].push(lt),"function"==typeof e.afterCreateEntity&&(pt=e.afterCreateEntity),pt&&pt(e),lt=this.game.lifecycle.triggerHook("after.createEntity",e)}
...
"use strict";function layoutEntity(t,i){var o=this,e=this.game.findEntity(t);if(!e)throw new Error("Container not found: "+t);var n=e.position||{x:0,y:0,z:0},r="none",s="center";if(e.style&&e.style.layout&&(r=e.style.layout),e.style&&e.style.origin&&(s=e.style.origin),e.items||(e.items=[]),e.items.push(i),"none"===r){var a=this.game.getEntity(i);if(!a)return void console.error("Entity not found: "+i);var y=0,l=0;"top-left"===s&&(y=-e.size.width/2,l=-e.size.height/2);var u={x:n.x+y+a.position.x-e.size.width/2,y:n.y+l+a.position.y-e.size.height/2,z:n.z};this.game.updateEntity({id:i,position:u})}if("grid"===r){var d=e.style.grid.columns,c=e.style.grid.rows;if("number"!=typeof d||"number"!=typeof c)throw console.log("containerEnt.layout",e.layout),new Error("Grid layout requires cols and rows to be numbers");var g=e.items||[];g=g.map(function(t){return o.game.getEntity(t)});var h=e.size,f=h.width/d,m=h.height/c;g.forEach(function(t,i){var r=Math.floor(i/d),s=i%d;if(t){var a=e.style.paddingTop||20,y=e.style.paddingLeft||-10,l=n.x-h.width/2+y,u=n.y-h.height/2+a,c=(n.z,{x:l+s*f+f/2,y:u+r*m+m/2,z:t.position.z});o.game.updateEntity({id:t.id,position:c})}else console.log("warning: item not found in container",i,t)})}if("stack"===r){var p,E=this.game.getEntity(i);if(!E)return void console.error("Entity not found: "+i);p=E.size.height+5;var v=e.items.length-1,z={x:n.x+0*v,y:n.y+v*p,z:n.z};this.game.updateEntity({id:i,position:z}),console.log("Entity ".concat(i," stacked at index ").concat(v," with position (").concat(z.x,", ").concat(z.y,", ").concat(z.z,") relative to container"))}if("function"==typeof r)throw console.log("adding item to container using custom layout algorithm"),new Error("Custom layout algorithm functions are yet implemented!")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=layoutEntity;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=updateEntity;var _ensureColorInt=_interopRequireDefault(require("./util/ensureColorInt.js"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function ownKeys(e,t){var o=Object.keys(e);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(e);t&&(i=i.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),o.push.apply(o,i)}return o}function _objectSpread(e){for(var t=1;t<arguments.length;t++){var o=null!=arguments[t]?arguments[t]:{};t%2?ownKeys(Object(o),!0).forEach(function(t){_defineProperty(e,t,o[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(o)):ownKeys(Object(o)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(o,t))})}return e}function _defineProperty(e,t,o){return(t=_toPropertyKey(t))in e?Object.defineProperty(e,t,{value:o,enumerable:!0,configurable:!0,writable:!0}):e[t]=o,e}function _toPropertyKey(e){var t=_toPrimitive(e,"string");return"symbol"===_typeof(t)?t:String(t)}function _toPrimitive(e,t){if("object"!==_typeof(e)||null===e)return e;var o=e[Symbol.toPrimitive];if(void 0!==o){var i=o.call(e,t||"default");if("object"!==_typeof(i))return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}function updateEntity(e,t){if(t="string"==typeof e||"number"==typeof e?_objectSpread({id:e},t):e,null==(t=this.game.lifecycle.triggerHook("before.updateEntity",t)))return console.warn("updateEntity was not provided a valid entityData",t),void console.warn("This is most likely the result of passing invalid data to updateEntity()");var o=t.id;if(void 0===o&&t.name){var i=this.game.getEntityByName(t.name);i&&(o=i.id)}if(void 0===o)return console.log("Error: updateEntity was not provided a valid entity.id or entity.name",t),void console.log("This is most likely the result of passing invalid data to updateEntity()");var n=this.game.getEntity(o);if(!n)return console.log("Error: updateEntity called for non-existent entity",o,t),void console.log("This should not happen, if a new state came in it should be created");if(!t.destroyed){if(n.pendingRender={},this.game.graphics.forEach(function(e){n.pendingRender[e.id]=!0}),t.color){var s=(0,_ensureColorInt.default)(t.color);this.game.components.color.set(o,s)}var r=!1;if(t.height&&(r=!0,this.game.components.height.set(o,t.height)),t.width&&(r=!0,this.game.components.width.set(o,t.width)),t.radius&&(r=!0),t.size&&(r=!0,this.game.components.size.set(o,t.size)),r&&this.game.physics.setBodySize(o,t),t.position&&(this.game.components.position.set(o,t.position),this.game.physics.setPosition(o,t.position)),t.velocity&&this.game.physics.setVelocity(o,t.velocity),t.health&&this.game.components.health.set(o,t.health),void 0!==t.thickness&&null!==t.thickness&&this.game.components.width.set(o,t.thickness),void 0!==t.update){var a=this.game.components.update.get(o);if(this.game.data.ents._[o])if(null===t.update)this.game.components.update.set(o,null);else{var c=this.game.make();c.onUpdate(t.update),a&&a.handlers&&a.handlers.length&&a.handlers.forEach(function(e){c.onUpdate(e)}),n.update=c.config.update,this.game.components.update.set(o,c.config.update)}}if(void 0!==t.value&&this.game.components.value.set(o,t.value),void 0!==t.meta&&this.game.components.meta.set(o,t.meta),void 0!==t.score&&null!==t.score&&this.game.components.score.set(o,t.score),void 0!==t.rotation&&(this.game.physics&&this.game.physics.setRotation?this.game.physics.setRotation(o,t.rotation):console.log("WARNING: physics.setRotation is not defined")),void 0!==t.text&&this.game.components.text.set(o,t.text),void 0!==t.items&&this.game.components.items.set(o,t.items),void 0!==t.sutra&&this.game.components.sutra.set(o,t.sutra),void 0!==t.items&&this.game.components.items.set(o,t.items),void 0!==t.style&&this.game.components.style.set(o,t.style),void 0!==t.texture){var p,u=this.game.components.texture.get(o);p="string"==typeof t.texture?t.texture:_objectSpread(_objectSpread({},u),t.texture),this.game.components.texture.set(o,p)}return this.game.systems.rbush,n=this.game.lifecycle.triggerHook("after.updateEntity",n)}this.removeEntity(o)}
