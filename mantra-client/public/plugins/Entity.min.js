...
"use strict";function inflateEntity(e){var t=this.game;if(!0===e.destroyed)return t.removeGraphic(e.id),void t.removeEntity(e.id);if(!t.removedEntities.has(e.id)){if(null!=e.source){if(t.components.source.get(e.source+"-"+e.id))return e.id=e.source.split("_")[1],updateOrCreate(t,e);delete e.id;var r=e.type;if(r){r=(r=r.toLowerCase()).charAt(0).toUpperCase()+r.slice(1);try{var i=this.game.make();i[r](e);var a=i.build();for(var d in a)e[d]=a[d];for(var n in e)void 0!==e[n]&&null!==e[n]||delete e[n]}catch(r){defaultBuild(t,e)}}else defaultBuild(t,e);return updateOrCreate(t,e)}return updateOrCreate(t,e)}console.log("Skipping update for locally removed entity:",e.id)}function defaultBuild(e,t){var r=e.make().build();for(var i in r)void 0!==t[i]&&null!==t[i]||(t[i]=r[i]);for(var a in t)void 0!==t[a]&&null!==t[a]||delete t[a]}function updateOrCreate(e,t){return e.entities.get(t.id)?e.updateEntity(t):e.createEntity(t)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=inflateEntity;
