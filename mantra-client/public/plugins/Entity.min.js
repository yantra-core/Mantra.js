...
"use strict";function layoutEntity(t,i){var e=this,o=this.game.findEntity(t);if(!o)throw new Error("Container not found: "+t);var n=o.position||{x:0,y:0,z:0},r="none",a="center";if(o.style&&o.style.layout&&(r=o.style.layout),o.style&&o.style.origin&&(a=o.style.origin),o.meta&&o.meta.layout&&(r=o.meta.layout),o.items||(o.items=[]),o.items.push(i),"none"===r){var s=this.game.getEntity(i);if(!s)return void console.error("Entity not found: "+i);var y=0,l=0;"top-left"===a&&(y=-o.size.width/2,l=-o.size.height/2);var u={x:n.x+y+s.position.x-o.size.width/2,y:n.y+l+s.position.y-o.size.height/2,z:n.z};this.game.updateEntity({id:i,position:u})}if("grid"===r){var c=o.meta.grid.columns||1,d=o.meta.grid.rows||1;if(o.style&&o.style.grid&&(c=o.style.grid.columns||c,d=o.style.grid.rows||d),"number"!=typeof c||"number"!=typeof d)throw console.log("containerEnt.layout",o.layout),new Error("Grid layout requires cols and rows to be numbers");var g=o.items||[];g=g.map(function(t){return e.game.getEntity(t)});var m=o.size,h=m.width/c,f=m.height/d;g.forEach(function(t,i){var o=Math.floor(i/c),r=i%c;if(t){var a=n.x-m.width/2+0,s=n.y-m.height/2+0,y=(n.z,{x:a+r*h+h/2,y:s+o*f+f/2,z:t.position.z});e.game.updateEntity({id:t.id,position:y},{skipAfterUpdateEntity:!0})}else console.log("warning: item not found in container",i,t)})}if("stack"===r){var p,E=this.game.getEntity(i);if(!E)return void console.error("Entity not found: "+i);p=E.size.height+5;var v=o.items.length-1,w={x:n.x+0*v,y:n.y+v*p,z:n.z};this.game.updateEntity({id:i,position:w}),console.log("Entity ".concat(i," stacked at index ").concat(v," with position (").concat(w.x,", ").concat(w.y,", ").concat(w.z,") relative to container"))}if("function"==typeof r)throw console.log("adding item to container using custom layout algorithm"),new Error("Custom layout algorithm functions are yet implemented!")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=layoutEntity;
