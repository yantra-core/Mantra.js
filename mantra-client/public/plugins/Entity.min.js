...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=updateEntity;var _ensureColorInt=_interopRequireDefault(require("./util/ensureColorInt.js"));function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function ownKeys(t,e){var o=Object.keys(t);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(t);e&&(i=i.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),o.push.apply(o,i)}return o}function _objectSpread(t){for(var e=1;e<arguments.length;e++){var o=null!=arguments[e]?arguments[e]:{};e%2?ownKeys(Object(o),!0).forEach(function(e){_defineProperty(t,e,o[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(o)):ownKeys(Object(o)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(o,e))})}return t}function _defineProperty(t,e,o){return(e=_toPropertyKey(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function _toPropertyKey(t){var e=_toPrimitive(t,"string");return"symbol"===_typeof(e)?e:String(e)}function _toPrimitive(t,e){if("object"!==_typeof(t)||null===t)return t;var o=t[Symbol.toPrimitive];if(void 0!==o){var i=o.call(t,e||"default");if("object"!==_typeof(i))return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===e?String:Number)(t)}function updateEntity(t,e){if(e="string"==typeof t||"number"==typeof t?_objectSpread({id:t},e):t,null==(e=this.game.lifecycle.triggerHook("before.updateEntity",e)))return console.warn("updateEntity was not provided a valid entityData",e),void console.warn("This is most likely the result of passing invalid data to updateEntity()");var o=e.id;if(void 0===o&&e.name){var i=this.game.getEntityByName(e.name);i&&(o=i.id)}if(void 0===o)return console.log("Error: updateEntity was not provided a valid entity.id or entity.name",e),void console.log("This is most likely the result of passing invalid data to updateEntity()");var n=this.game.getEntity(o);if(!n)return console.log("Error: updateEntity called for non-existent entity",o,e),void console.log("This should not happen, if a new state came in it should be created");if(!e.destroyed){if(n.pendingRender={},this.game.graphics.forEach(function(t){n.pendingRender[t.id]=!0}),e.color){var s=(0,_ensureColorInt.default)(e.color);this.game.components.color.set(o,s)}var r=!1;if(e.height&&(r=!0,this.game.components.height.set(o,e.height)),e.width&&(r=!0,this.game.components.width.set(o,e.width)),e.radius&&(r=!0),e.size&&(r=!0,this.game.components.size.set(o,e.size)),r&&this.game.physics.setBodySize(o,e),e.position&&(this.game.components.position.set(o,e.position),this.game.physics.setPosition(o,e.position)),e.velocity&&this.game.physics.setVelocity(o,e.velocity),e.health&&this.game.components.health.set(o,e.health),void 0!==e.thickness&&null!==e.thickness&&this.game.components.width.set(o,e.thickness),void 0!==e.update){var a=this.game.components.update.get(o);if(this.game.data.ents._[o])if(null===e.update)this.game.components.update.set(o,null);else{var p=this.game.make();p.onUpdate(e.update),a&&a.handlers&&a.handlers.length&&a.handlers.forEach(function(t){p.onUpdate(t)}),n.update=p.config.update,this.game.components.update.set(o,p.config.update)}}if(void 0!==e.value&&this.game.components.value.set(o,e.value),void 0!==e.meta&&this.game.components.meta.set(o,e.meta),void 0!==e.score&&null!==e.score&&this.game.components.score.set(o,e.score),void 0!==e.rotation&&(this.game.physics&&this.game.physics.setRotation?this.game.physics.setRotation(o,e.rotation):console.log("WARNING: physics.setRotation is not defined")),void 0!==e.text&&this.game.components.text.set(o,e.text),void 0!==e.items&&this.game.components.items.set(o,e.items),void 0!==e.sutra&&this.game.components.sutra.set(o,e.sutra),void 0!==e.items&&this.game.components.items.set(o,e.items),void 0!==e.style&&this.game.components.style.set(o,e.style),void 0!==e.texture){var c,u=this.game.components.texture.get(o);c="string"==typeof e.texture?e.texture:_objectSpread(_objectSpread({},u),e.texture),this.game.components.texture.set(o,c)}this.game.systems.rbush;var l,m=this.game.getEntity(o);return"function"==typeof m.afterUpdateEntity&&(l=m.afterUpdateEntity),l&&l(m),m=this.game.lifecycle.triggerHook("after.updateEntity",m)}this.removeEntity(o)}
