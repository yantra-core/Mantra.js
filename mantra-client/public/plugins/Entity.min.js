...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=createEntity;var _Entity=_interopRequireDefault(require("../../../Entity/Entity.js")),_TimersComponent=_interopRequireDefault(require("../../../Component/TimersComponent.js")),_ensureColorInt=_interopRequireDefault(require("./util/ensureColorInt.js")),_layoutEntity=_interopRequireDefault(require("./layoutEntity.js"));function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function ownKeys(t,e){var i=Object.keys(t);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(t);e&&(n=n.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),i.push.apply(i,n)}return i}function _objectSpread(t){for(var e=1;e<arguments.length;e++){var i=null!=arguments[e]?arguments[e]:{};e%2?ownKeys(Object(i),!0).forEach(function(e){_defineProperty(t,e,i[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(i)):ownKeys(Object(i)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(i,e))})}return t}function _defineProperty(t,e,i){return(e=_toPropertyKey(e))in t?Object.defineProperty(t,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[e]=i,t}function _toPropertyKey(t){var e=_toPrimitive(t,"string");return"symbol"===_typeof(e)?e:String(e)}function _toPrimitive(t,e){if("object"!==_typeof(t)||null===t)return t;var i=t[Symbol.toPrimitive];if(void 0!==i){var n=i.call(t,e||"default");if("object"!==_typeof(n))return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===e?String:Number)(t)}function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function distanceSquared(t,e,i,n){var o=i-t,a=n-e;return o*o+a*a}function deferEntityCreation(t){spatialStructure.add(t)}function createEntity(){var t,e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},i=arguments.length>1&&void 0!==arguments[1]&&arguments[1];if(e=this.game.lifecycle.triggerHook("before.createEntity",e),!i){var n={id:t=this._generateId(),name:null,kind:null,body:!0,shape:"triangle",color:null,position:{x:0,y:0,z:0},startingPosition:null,velocity:{x:0,y:0,z:0},rotation:0,mass:100,density:100,health:1/0,score:0,height:16,width:16,depth:16,size:{width:100,height:100,depth:16},lifetime:null,maxSpeed:100,isStatic:!1,isSensor:!1,restitution:0,container:null,items:null,sutra:null,scene:[],meta:null,collectable:!1,hasInventory:!0,owner:0,source:null,inputs:null,value:null,destroyed:!1,type:"NONE",friction:.1,frictionAir:.01,frictionStatic:.5,lockedProperties:null,actionRateLimiter:null,timers:null,yCraft:null,text:null,style:null,texture:null,collisionStart:!0,collisionActive:!1,collisionEnd:!1,pointerdown:!1,pointerup:!1,pointermove:!1,pointerover:!1,pointerout:!1,pointerenter:!1,pointerleave:!1,onDrop:null,afterItemCollected:null,afterRemoveEntity:null,afterCreateEntity:null,afterUpdate:null,update:null,exit:null,ctick:this.game.tick,utick:this.game.tick};if("object"===_typeof(e.size)?(e.width=e.size.width,e.height=e.size.height,e.depth=e.size.depth):e.size={width:e.width,height:e.height,depth:e.depth},(e=_objectSpread(_objectSpread({},n),e)).position&&("number"!=typeof e.position.x||isNaN(e.position.x)||"number"!=typeof e.position.y||isNaN(e.position.y)))throw console.log("Entity.createEntity could not create with data",e),new Error("Invalid position for entity");if(this.game.systems.rbush&&this.game.systems.rbush.addEntity(e),this.game.deferredEntities[e.id.toString()]=e,this.game.config.useFoV){var o=this.game.getCurrentPlayer();if(o){var a=e.position||{x:0,y:0,z:0};if(distanceSquared(o.position.x,o.position.y,a.x,a.y)>this.game.data.fieldOfView*this.game.data.fieldOfView)return}}}t=e.id;new _Entity.default(t);e.startingPosition||(e.startingPosition=e.position);var r,s=e,d=s.name,m=s.type,p=s.kind,l=s.position,h=s.rotation,c=s.startingPosition,u=s.body,g=s.mass,y=s.density,f=s.velocity,C=s.isSensor,v=s.isStatic,b=s.lockedProperties,E=s.width,_=s.height,w=s.depth,S=s.size,P=s.radius,j=s.shape,x=s.color,O=s.maxSpeed,R=s.health,k=s.score,I=s.items,D=s.container,q=s.sutra,z=s.scene,A=s.meta,N=s.collectable,L=s.hasInventory,T=s.owner,K=s.source,V=s.inputs,Y=s.value,U=s.lifetime,H=s.yCraft,M=s.text,F=s.style,W=s.texture,B=s.collisionActive,G=s.collisionStart,J=s.collisionEnd,Q=s.pointerdown,X=s.pointerup,Z=s.pointermove,$=s.pointerenter,tt=s.pointerleave,et=s.pointerover,it=s.pointerout,nt=s.onDrop,ot=s.afterRemoveEntity,at=(s.afterCreateEntity,s.afterUpdateEntity),rt=s.afterItemCollected,st=s.update,dt=s.exit,mt=s.ctick,pt=s.utick,lt=(l.x,l.y,(0,_ensureColorInt.default)(x));if(this.game.addComponent(t,"type",m||"PLAYER"),this.game.addComponent(t,"name",d||null),this.game.addComponent(t,"kind",p),this.game.addComponent(t,"position",l),this.game.addComponent(t,"startingPosition",c),this.game.addComponent(t,"velocity",f),this.game.addComponent(t,"rotation",h),this.game.addComponent(t,"mass",g),this.game.addComponent(t,"density",y),this.game.addComponent(t,"health",R),this.game.addComponent(t,"score",k),this.game.addComponent(t,"width",E),this.game.addComponent(t,"height",_),this.game.addComponent(t,"depth",w),this.game.addComponent(t,"size",S),this.game.addComponent(t,"radius",P),this.game.addComponent(t,"shape",j),this.game.addComponent(t,"color",lt),this.game.addComponent(t,"maxSpeed",O),this.game.addComponent(t,"owner",T),this.game.addComponent(K,"source",K+"_"+t),this.game.addComponent(t,"items",I),this.game.addComponent(t,"scene",z),this.game.addComponent(t,"meta",A),this.game.addComponent(t,"collectable",N),this.game.addComponent(t,"hasInventory",L),this.game.addComponent(t,"value",Y),this.game.addComponent(t,"inputs",V),this.game.addComponent(t,"lifetime",U),this.game.addComponent(t,"destroyed",!1),this.game.addComponent(t,"creationTime",Date.now()),this.game.addComponent(t,"isSensor",C),this.game.addComponent(t,"isStatic",v),this.game.addComponent(t,"lockedProperties",b),this.game.addComponent(t,"actionRateLimiter",{}),this.game.addComponent(t,"timers",new _TimersComponent.default("timers",t,this.game)),this.game.addComponent(t,"yCraft",H),this.game.addComponent(t,"text",M),this.game.addComponent(t,"style",F),this.game.addComponent(t,"texture",W),this.game.addComponent(t,"afterItemCollected",rt),this.game.addComponent(t,"afterRemoveEntity",ot),this.game.addComponent(t,"afterCreateEntity",ot),this.game.addComponent(t,"afterUpdateEntity",at),this.game.addComponent(t,"collisionActive",B),this.game.addComponent(t,"collisionStart",G),this.game.addComponent(t,"collisionEnd",J),this.game.addComponent(t,"pointerdown",Q),this.game.addComponent(t,"pointerup",X),this.game.addComponent(t,"pointermove",Z),this.game.addComponent(t,"pointerenter",$),this.game.addComponent(t,"pointerleave",tt),this.game.addComponent(t,"pointerover",et),this.game.addComponent(t,"pointerout",it),this.game.addComponent(t,"onDrop",nt),this.game.addComponent(t,"update",st),this.game.addComponent(t,"exit",dt),this.game.addComponent(t,"ctick",mt),this.game.addComponent(t,"utick",pt),"object"===_typeof(q)&&null!==q&&"function"==typeof q.rules?("object"!==_typeof(q.config)&&(q.config={}),r=q.rules(this.game,t,q.config)):r=q,this.game.addComponent(t,"sutra",r),u){var ht={entityId:t,width:E,height:_,radius:P,type:m,shape:j,position:l,velocity:f,rotation:h,mass:g,density:y,isStatic:v,isSensor:C,restitution:e.restitution,friction:e.friction,frictionAir:e.frictionAir,frictionStatic:e.frictionStatic};ht.myEntityId=t,this.game.physics.addToWorld(ht),!f||0===f.x&&0===f.y||this.game.physics.setVelocity(t,f),l&&this.game.physics.setPosition(t,l),void 0!==h&&this.game.physics&&this.game.physics.setRotation&&this.game.physics.setRotation(t,h)}this.game.entities.set(t,{id:t});var ct,ut=this.game.getEntity(t);(void 0===ut.pendingRender&&(ut.pendingRender={}),this.game.graphics.forEach(function(t){ut.pendingRender[t.id]=!0}),this.game.entities.set(t,ut),D&&this.layoutEntity(D,t),this.game.data.ents=this.game.data.ents||{},this.game.data.ents._=this.game.data.ents._||{},this.game.data.ents._[t]=ut,this.game.data.ents[ut.type]=this.game.data.ents[ut.type]||[],this.game.data.ents[ut.type].push(ut),"PLAYER"===ut.type&&this.game.data.ents.PLAYER)&&(Object.keys(this.game.data.ents.PLAYER).length<1&&this.game.setPlayerId(t));return"function"==typeof e.afterCreateEntity&&(ct=e.afterCreateEntity),ct&&ct(e),ut=this.game.lifecycle.triggerHook("after.createEntity",e)}
...
"use strict";function inflateEntity(t){var e=this.game;if(!0===t.destroyed)return e.removeGraphic(t.id),void e.removeEntity(t.id);if(!e.removedEntities.has(t.id)){if(null!=t.source){if(e.components.source.get(t.source+"-"+t.id))return t.id=t.source.split("_")[1],updateOrCreate(e,t);delete t.id;var i=t.type;if(i){i=(i=i.toLowerCase()).charAt(0).toUpperCase()+i.slice(1);try{var a=this.game.make();a[i](t);var r=a.build();for(var n in r)t[n]=r[n];for(var d in t)void 0!==t[d]&&null!==t[d]||delete t[d]}catch(i){defaultBuild(e,t)}}else defaultBuild(e,t);return updateOrCreate(e,t)}return updateOrCreate(e,t)}console.log("Skipping update for locally removed entity:",t.id)}function defaultBuild(game,entityData){var defaultConfig=game.make().build();for(var p in defaultConfig)void 0!==entityData[p]&&null!==entityData[p]||(entityData[p]=defaultConfig[p]);var supportedSerializedEvents=["collisionStart"];for(var _p2 in entityData){if(supportedSerializedEvents.includes(_p2))try{entityData[_p2]=eval("("+entityData[_p2]+")")}catch(t){console.log("Failed to inflate serialized function",entityData.type,entityData[_p2],entityData,t)}void 0!==entityData[_p2]&&null!==entityData[_p2]||delete entityData[_p2]}}function updateOrCreate(t,e){return t.entities.get(e.id)?t.updateEntity(e):t.createEntity(e)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=inflateEntity;

},{}],8:[function(require,module,exports){
"use strict";function _createForOfIteratorHelper(t,e){var i="undefined"!=typeof Symbol&&t[Symbol.iterator]||t["@@iterator"];if(!i){if(Array.isArray(t)||(i=_unsupportedIterableToArray(t))||e&&t&&"number"==typeof t.length){i&&(t=i);var o=0,n=function(){};return{s:n,n:function(){return o>=t.length?{done:!0}:{done:!1,value:t[o++]}},e:function(t){throw t},f:n}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var r,a=!0,s=!1;return{s:function(){i=i.call(t)},n:function(){var t=i.next();return a=t.done,t},e:function(t){s=!0,r=t},f:function(){try{a||null==i.return||i.return()}finally{if(s)throw r}}}}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var i=Object.prototype.toString.call(t).slice(8,-1);return"Object"===i&&t.constructor&&(i=t.constructor.name),"Map"===i||"Set"===i?Array.from(t):"Arguments"===i||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)?_arrayLikeToArray(t,e):void 0}}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var i=0,o=new Array(e);i<e;i++)o[i]=t[i];return o}function layoutEntity(t,e){var i=this,o=this.game.findEntity(t);if(!o)throw new Error("Container not found: "+t);var n=o.position||{x:0,y:0,z:0},r="none",a="center";if(o.style&&o.style.layout&&(r=o.style.layout),o.style&&o.style.origin&&(a=o.style.origin),o.meta&&o.meta.layout&&(r=o.meta.layout),o.items||(o.items=[]),o.items.push(e),"flex"===r){var s=o.meta.flex||o.style.flex,l=o.items.map(function(t){return i.game.getEntity(t)});applyFlexLayout.call(this,o,l,s)}else if("grid"===r){var y=o.meta.grid||o.style.grid,u=o.items.map(function(t){return i.game.getEntity(t)});applyGridLayout.call(this,o,u,y)}if("none"===r){var c=this.game.getEntity(e);if(!c)return void console.error("Entity not found: "+e);var f=c.position.x,d=c.position.y;"top-left"===a?(f=-c.size.width/2,d=-c.size.height/2):(f-=c.size.width/2,d-=c.size.height/2);var p=o.position,h={x:p.x+-c.size.width/2,y:p.y+-c.size.height/2,z:n.z};h.x=n.x+f,h.y=n.y+d,this.game.updateEntity({id:e,position:h})}if("grid"===r){var g=o.meta.grid.columns||1,m=o.meta.grid.rows||1;if(o.style&&o.style.grid&&(g=o.style.grid.columns||g,m=o.style.grid.rows||m),"number"!=typeof g||"number"!=typeof m)throw console.log("containerEnt.layout",o.layout),new Error("Grid layout requires cols and rows to be numbers");var v=o.items||[];v=v.map(function(t){return i.game.getEntity(t)});var x=o.size,w=x.width/g,z=x.height/m;v.forEach(function(t,e){var o=Math.floor(e/g),r=e%g;if(t){var a=n.x-x.width/2+0,s=n.y-x.height/2+0,l=(n.z,{x:a+r*w+w/2,y:s+o*z+z/2,z:t.position.z});i.game.updateEntity({id:t.id,position:l},{skipAfterUpdateEntity:!0})}else console.log("warning: item not found in container",e,t)})}if("stack"===r){var E,b=this.game.getEntity(e);if(!b)return void console.error("Entity not found: "+e);E=b.size.height+5;var A=o.items.length-1,_={x:n.x+0*A,y:n.y+A*E,z:n.z};this.game.updateEntity({id:e,position:_}),console.log("Entity ".concat(e," stacked at index ").concat(A," with position (").concat(_.x,", ").concat(_.y,", ").concat(_.z,") relative to container"))}if("function"==typeof r)throw console.log("adding item to container using custom layout algorithm"),new Error("Custom layout algorithm functions are yet implemented!")}function applyFlexLayout(t,e,i){var o,n=i.flexDirection,r=void 0===n?"row":n,a=(i.justifyContent,i.alignItems),s=void 0===a?"center":a,l=r.includes("row"),y=l?"width":"height",u=l?"height":"width",c=l?"x":"y",f=l?"y":"x",d=0,p=_createForOfIteratorHelper(e);try{for(p.s();!(o=p.n()).done;){var h=o.value;switch(h.position[c]=d,d+=h.size[y],s){case"flex-start":h.position[f]=0;break;case"flex-end":h.position[f]=t.size[u]-h.size[u];break;case"center":default:h.position[f]=(t.size[u]-h.size[u])/2}this.game.updateEntity({id:h.id,position:h.position})}}catch(t){p.e(t)}finally{p.f()}}function applyGridLayout(t,e,i){var o=this,n=i.gridTemplateColumns,r=void 0===n?"1fr":n,a=(i.gridTemplateRows,r.split(" ").length),s=Math.ceil(e.length/a),l=t.size.width/a,y=t.size.height/s;e.forEach(function(t,e){var i=e%a,n=Math.floor(e/a);t.position.x=i*l,t.position.y=n*y,o.game.updateEntity({id:t.id,position:t.position})})}function getCumulativePosition(t){var e={x:t.position.x,y:t.position.y,z:t.position.z};if(!t.container)return e;var i=game.getEntityByName(t.container);return i&&(e.x+=i.position.x,e.y+=i.position.y,i=i.parent),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=layoutEntity;
