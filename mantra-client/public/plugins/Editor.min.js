...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=createToolbar;var _GraphicsSelector=_interopRequireDefault(require("./GraphicsSelector.js")),_WorldSelector=_interopRequireDefault(require("./WorldSelector.js")),_ToolbarMenu=_interopRequireDefault(require("./ToolbarMenu.js"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function createToolbar(e){var t=this,n=(this.createMenu("File"),new _ToolbarMenu.default);this.toolbarMenu=n;var o=!1;e.on("entityInput::handleInputs",function(e,t){t.controls&&void 0!==t.controls.U&&(!0!==t.controls.U||o?!1===t.controls.U&&(o=!1):(o=!0,"open"===n.toggleStatus?n.slideOutToolbar():n.slideInToolbar()))});var r=this.game.assetRoot||"https://yantra.gg",i=this.createIcon("search");i.src=r+"/vendor/feather/search.svg",i.style.cursor="pointer",i.title="Click to open Entity Inspector",i.style.marginRight="10px",i.style.marginLeft="10px",i.style.marginTop="5px",i.style.filter="invert(100%)",is_touch_enabled()&&(i.style.display="none"),i.onclick=function(){return t.showInspector()},n.addItem("primary",{text:"Mantra",icon:this.createIcon("slack")}),n.addItem("primary",{text:"Entities",hint:"Manage Game Entities",icon:this.createIcon("box"),onClick:function(){return t.showEntities()}}),n.addItem("primary",{text:"Rules",hint:"Manage Game Rules with Sutra",icon:this.createIcon("pocket"),onClick:function(){return t.showRules()}}),n.addItem("primary",{text:"Events ",hint:"Manage Game Events",icon:this.createIcon("activity"),onClick:function(){return t.showEventsInspector()}});var l=this.createIcon("globe");l.style.marginTop="0px",l.style.paddingTop="0px",l.style.position="relative",l.style.top="10px";var a=this.createIcon("tv");a.style.marginTop="0px",a.style.paddingTop="0px",a.style.position="relative",a.style.top="10px";var s=new _GraphicsSelector.default(this);s.selectBox.style.fontSize="22px",s.selectBox.style.cursor="pointer",s.selectBox.style.margin="20px";var c=document.createElement("div");c.appendChild(a);var p=document.createElement("span");p.style.fontSize="22px",p.style.marginRight="10px",p.style.marginLeft="10px",p.style.marginTop="10px",p.style.marginBottom="10px",p.style.cursor="pointer",p.innerText="Graphics",c.appendChild(p),c.onpointerdown=function(){d.selectPicker.hideModal(),s.selectPicker.toggle()},c.appendChild(s.selectBox),c.title="Select Graphics Engine";var d=new _WorldSelector.default(this.game);d.selectBox.style.fontSize="22px",d.selectBox.style.cursor="pointer",d.selectBox.style.margin="20px";var u=document.createElement("div");u.appendChild(l);var h=document.createElement("span");h.style.fontSize="22px",h.style.marginRight="10px",h.style.marginLeft="10px",h.style.marginTop="10px",h.style.marginBottom="10px",h.style.cursor="pointer",h.innerText="Worlds",u.appendChild(h),u.onpointerdown=function(){s.selectPicker.hideModal(),d.selectPicker.toggle()},u.appendChild(d.selectBox),u.title="Select World";var y=document.createElement("div");if(y.style.display="flex",y.style.alignItems="center",y.style.justifyContent="space-between",y.style.margin="20px",y.appendChild(i),y.appendChild(c),y.appendChild(u),n.addElement("secondary",y),e.worlds.length>0){var m=e.worlds[0].constructor.name;d.selectElement(m)}n.slideOutToolbar(),$("body").append(n.toolbar)}function is_touch_enabled(){return"ontouchstart"in window||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0}
