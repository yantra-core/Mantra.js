...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=createToolbar;var _GraphicsSelector=_interopRequireDefault(require("./GraphicsSelector.js")),_WorldSelector=_interopRequireDefault(require("./WorldSelector.js")),_ToolbarMenu=_interopRequireDefault(require("./ToolbarMenu.js"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function createToolbar(e){var t=this,n=(this.createMenu("File"),new _ToolbarMenu.default);this.toolbarMenu=n;var o=!1;e.on("entityInput::handleInputs",function(e,t){t.controls&&void 0!==t.controls.U&&(!0!==t.controls.U||o?!1===t.controls.U&&(o=!1):(o=!0,"open"===n.toggleStatus?n.slideOutToolbar():n.slideInToolbar()))});var r=this.game.assetRoot||"https://yantra.gg",i=this.createIcon("search");i.src=r+"/vendor/feather/search.svg",i.style.cursor="pointer",i.title="Click to open Entity Inspector",i.style.marginRight="10px",i.style.marginLeft="5px",i.style.width="32px",i.style.height="32px",i.style.bottom="12px",i.style.position="relative",i.style.filter="invert(100%)",i.style.display="none",is_touch_enabled()&&(i.style.display="none"),i.onclick=function(){return t.showInspector()};var s=this.createIcon("x");s.src=r+"/vendor/feather/x.svg",s.style.cursor="pointer",s.title="Click to open Entity Inspector",s.style.marginRight="10px",s.style.marginLeft="5px",s.style.width="32px",s.style.height="32px",s.style.top="6px",s.style.position="relative",s.style.filter="invert(100%)",s.onclick=function(){return n.slideOutToolbar()},n.addItem("primary",{text:"Mantra",icon:this.createIcon("slack"),onClick:function(){window.open("https://github.com/yantra-core/Mantra.js","_blank")}}),n.addItem("primary",{text:"Entities",hint:"Manage Game Entities",icon:this.createIcon("box"),onClick:function(){return t.showEntities()}}),n.addItem("primary",{text:"Rules",hint:"Manage Game Rules with Sutra",icon:this.createIcon("pocket"),onClick:function(){return t.showRules()}}),n.addItem("primary",{text:"Events ",hint:"Manage Game Events",icon:this.createIcon("activity"),onClick:function(){return t.showEventsInspector()}});var a=document.createElement("div");a.style.display="flex",a.style.alignItems="center",a.style.justifyContent="space-between",a.style.margin="20px",n.addElement("middle",a);var l=document.createElement("span");if(l.style.fontSize="22px",l.style.position="relative",l.style.marginRight="10px",l.style.marginLeft="10px",l.style.bottom="10px",l.style.cursor="pointer",l.innerText=e.selectedEntityId?e.entities[e.selectedEntityId].constructor.name:"No Entity Selected",l.onclick=function(){return t.showInspector()},l.style.display="none",a.appendChild(l),a.appendChild(i),n.addElement("secondary",s),e.worlds.length>0)e.worlds[0].constructor.name;n.slideOutToolbar(),$("body").append(n.toolbar)}function is_touch_enabled(){return"ontouchstart"in window||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0}
